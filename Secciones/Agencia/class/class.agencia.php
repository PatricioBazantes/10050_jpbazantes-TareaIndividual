...
class agencia{
	...
	public function get_list(){
		...
		<table border="1" align="center" class="table-sm table-dark">
			...
			<tr>
				<th colspan="8"><a href="agencia.php?d=' . $d_new_final . '" class="Boton" id="nuevo">Nuevo</a></th>
			</tr>
			<tr>
				<th>Descipcion</th>
				<th>Direccion</th>
			...
			*/
				...
				$html .= '
					<tr>
						...
						<td><a href="agencia.php?d=' . $d_del_final . '" class="Boton" id="borrar">Borrar</a></td>
						<td><a href="agencia.php?d=' . $d_act_final . '" class="Boton" id="update">Actualizar</a></td>
						<td><a href="agencia.php?d=' . $d_det_final . '" class="Boton" id="detalle">Detalle</a></td>
					</tr>';
		    }
		}else{
