...
class vehiculo{
	...
	public function get_list(){
		...
		<table border="1" align="center" class="table-sm table-dark">
			...
			<tr>
				<th colspan="8"><a href="vehiculo.php?d=' . $d_new_final . '" class="Boton" id="nuevo">Nuevo</a></th>
			</tr>
			<tr>
				<th>Placa</th>
				<th>Marca</th>
			...
			*/
				...
				$html .= '
					<tr>
						...
						<td>' . $row['anio'] . '</td>
						<td>' . $row['avaluo'] . '</td>
						<td><a href="vehiculo.php?d=' . $d_del_final . '" class="Boton" id="borrar">Borrar</a></td>
						<td><a href="vehiculo.php?d=' . $d_act_final . '" class="Boton" id="update">Actualizar</a></td>
						<td><a href="vehiculo.php?d=' . $d_det_final . '" class="Boton" id="detalle">Detalle</a></td>
					</tr>';
		    }
		}else{
...
//***************************************************************************************************************************
	...
	private function _message_error($tipo){
		...
		<table border="0" align="center" class="table-sm table-dark">
			...
			<tr>
				<th><a href="../vehiculo.php" class="Boton" id="regresar">Regresar</a></th>
			</tr>
		</table>';
		return $html;
	}
