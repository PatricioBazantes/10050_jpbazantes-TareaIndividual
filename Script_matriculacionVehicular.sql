...
CREATE TABLE `agencia` (
  ...
  `horarioInicio` time COLLATE utf8_spanish2_ci NOT NULL,
  `horarioFin` time COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `agencia` (`id`, `descripcion`, `direccion`, `telefono`,`horarioInicio`, `horarioFin`, `foto`) VALUES
(1, 'Los Chillos', 'Gnral. Rumiñahui', '6054874','08:00:00', '16:00:00', NULL),
(2, 'Cotocollao', 'La prensa', '6048754','09:00:00', '18:00:00', NULL);
...
(1, 'Chévrolet', 'USA','Smith Ave', NULL),
(2, 'Fiat', 'Italia','America Ave', NULL),
(4, 'Great Wall', 'China','Wasington Ave', NULL),
(5, 'Toyota', 'Japón','Jackson Ave', NULL);
